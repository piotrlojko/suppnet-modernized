> [!IMPORTANT]
> # This repo is almost entirely a vibe-coded fork of the original `SUPPNet` code, and remains a work in progress. So do not expect it to work properly (although it seems to be).
